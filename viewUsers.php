                            ...
                            if (mysqli_num_rows($result)) {
                                ...
                                while ($row = mysqli_fetch_array(($result))) {
                                    if ($row['userType'] === 'admin') {
                                        ...
                                        echo "<td><a href=delete.php?id=".$row['userId']."><button onClick=showAlert() style=border:none;color:red;border-radius:5px;width:70px;height:40px; >delete</button></a></td>";
                                        echo "</tr>";
                                    }
                                }
                            } else {
