        ...
        <section>
            ...
            <div class="container">
                <div class="row" style="margin-top: 100px;">
                    <div class="col"></div>
                    <div class="col-8">
                        <h4 style="text-align: center;">Write a reply for the problem</h4>
                    </div>
                    <div class="col"></div>
                </div>
                <div class="row" style="margin-top: 80px;">
                    ...
                    <div class="col">
                        ...
                        <?php 
                            ...
                            $sql = "SELECT * FROM qureis WHERE quryId = $id";
                            $result = mysqli_query($con, $sql);
                            $row = mysqli_fetch_assoc($result);
                            echo "<h6><b>Name :</b></h6>";
                            echo "<h6>".$row['name']."</h6>";
                            echo "<h6><b>Question :</b></h6>";
                            echo "<h6>".$row['message']."</h6>";
                            
                        ?>
                        <form action="replyBackend.php" method="POST" autocomplete="off">
                            
                            <div>
                                <label style="  vertical-align: top; margin-top: 20px;" for="message"> Reply*</label>
                                <textarea style="width:500px;" class="txtarea" required type="text" id="message" name="message"></textarea>
                            </div>
