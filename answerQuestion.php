        ...
        <section>
            ...
            <div class="container">
                <div class="row" style="margin-top: 100px;">
                    <div class="col"></div>
                    <div class="col-8">
                        <h4 style="text-align: center;">Questions that farmers are sended</h4>
                    </div>
                    <div class="col"></div>
                </div>
                            ...
                            if (mysqli_num_rows($result)) {
                                ...
                                while ($row = mysqli_fetch_array(($result))) {
                                    if ($row['reply'] === '') {
                                        ...
                                        echo "<td><a href=reply.php?id=".$row['quryId']."><button onClick=showAlert() style=border:none;color:green;border-radius:5px;width:70px;height:40px; >Reply</button></a></td>";
                                        echo "</tr>";
                                    }
                                }
                            } else {
