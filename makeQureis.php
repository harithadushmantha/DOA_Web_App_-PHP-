                                ...
                                <li class="nav-item">
                                    ...
                                    if (isset($_SESSION["userType"])) {
                                        ...
                                        if ($_SESSION["userType"] === "farmer") {
                                            echo '<li class="nav-item">
                                            <a class="nav-link" href="#">Make Queries</a>
                                        </li>';
                                        }
                                    }
                                    ?>
        ...
        <section>
            ...
            <div class="container">
                <div class="row" style="margin-top: 100px;">
                    <div class="col"></div>
                    <div class="col-8">
                        <h4>Email your problem. Image/Video/PDF/Doc types can be used as attached file.</h4>
                    </div>
                    <div class="col"></div>
                </div>
                <div class="row" style="margin-top: 80px;">
                    <div class="col"></div>
                    <div class="col">
                        <form action="qureis.php" method="POST" autocomplete="off">
                            <div>
                                <label for="name"> Enter Your Name*</label>
                                <input style="margin-left: 7px;" class="nameInp" required type="text" id="name" name="name">
                            </div>
                            <div>
                                <label for="name"> Enter Your District*</label>
                                <input class="nameInp" style="margin-top: 10px;" required type="text" id="district" name="district">
                            </div>
                            <div>
                                <label style="  vertical-align: top; margin-top: 20px;" for="message"> Problem*</label>
                                <textarea style="margin-left: 67px;" class="txtarea" required type="text" id="message" name="message"></textarea>
                            </div>
